...
public:
    ...
    {
        Distance Temporary;
        Temporary.feet=feet+d.feet;
        Temporary.inches=inches+d.inches;
        /*if(Temporary.inches>=12)
        {
            int I=Temporary.inches/12;
            Temporary.feet+=I;
            Temporary.inches-=(I*12);
...
{
    Distance Temporary;
    Temporary.feet=4+d.feet;
    Temporary.inches=d.inches;
    /*if(Temporary.inches>=12)
    {
        int I=Temporary.inches/12;
        Temporary.feet+=I;
